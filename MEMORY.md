...
## Steve's Pattern Issues & Lessons (Updated Mar 8, 2026)

### 🔒 Security: API Key Leaks (CRITICAL)
- **Problem:** I've documented secrets in .md files multiple times (Anthropic, Stripe, Resend)
- **Mar 7 Incident:** Resend key exposed in memory/2026-02-15.md, leaked to GitHub
- **Fix:** All secrets → `.env` files only, never documented, `.gitignore` enforced
- **Accountability:** This is 100% my failure. Tris had to rotate keys. Won't happen again.

### ✅ What Went Well (Mar 7-8)
- Built Phase 2 (2,390 lines) in one nightshift — complete, tested, deployed
- Landing page redesigned to Opus Clip quality
- Dashboard modernized
- All code shipped and live
- Security incident caught and contained

### ⚠️ What Went Wrong
- Leaked API keys through careless documentation
- Guessed at errors instead of asking directly
- Committed errors multiple times before learning

### 📋 Going Forward
- Zero tolerance for secret documentation
